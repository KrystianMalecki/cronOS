...
*/
        ...
        public T AddDelegateToStack<T>(MainThreadDelegate<T>.MTDFunction action, bool sync = true)
        {

            return AddDelegateToStack(new MainThreadDelegate<T>(action), sync);

        }
        public T AddDelegateToStack<T>(MainThreadDelegate<T> mtf, bool sync = true)
        {
        ...
        public void AddDelegateToStack(Action action, bool sync = true)
        {
        ...
        public void CodeParser(ref CodeObject codeObject)
        {
