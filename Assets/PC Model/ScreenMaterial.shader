...
Shader "Custom/ScreenMaterial"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 scanLine(float2 uv, float3 col, float _ScanSpeed, float _LineScale, float _LineWeightMin,
                            float _LineWeightMax, float _LineDistributionPow, float _LineWeight)
            {
                float t = _Time * 10;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                if (_UseScanLines)
                {
                    ...
                    col = scanLine(uv, col, _ScanSpeed, _LineScale, _LineWeightMin, _LineWeightMax,
                                   _LineDistributionPow, _LineWeight);
                }
                if (_UseScanLines2)
                {
                    col = scanLine(uv, col, _ScanSpeed2, _LineScale2, _LineWeightMin2, _LineWeightMax2,
                                   _LineDistributionPow2, _LineWeight2);
                }
                if (_UseVignette)
                {
                    // Vignette
