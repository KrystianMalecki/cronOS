...
namespace UnityEditor.Searcher
{
    public class LuceneSearcherDatabase : SearcherDatabaseBase
    {
        ...
        class VSDocAnalyzer : Lucene.Net.Analysis.Analyzer
        {
            ...
            Dictionary<SearcherItem, IEnumerable<IIndexableField>> extraFields)
        {
            ...
            Lucene.Net.Analysis.Analyzer analyzer = new PerFieldAnalyzerWrapper(standardAnalyzer,
                new J2N.Collections.Generic.Dictionary<string, Lucene.Net.Analysis.Analyzer>
                {
                    {
